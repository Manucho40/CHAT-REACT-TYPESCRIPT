...
const ChatContent = ({handleMenu, contact, contacts} : Props) => {
  ...
  return (
    <div className='chatContent'>
        <div className="chatBar">
            <div className='bar'>
                <img src={contact.avatar == "" ? defaultImg : contact.avatar} alt="" />
                <div className='barInfos'>
                    <span className='userListName'>{pseudoFirstLetterMaj(contact.pseudo)}</span>
