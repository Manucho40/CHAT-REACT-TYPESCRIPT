    ...
    <div className="chatContent">
      <div className="chatBar">
        <div className="bar">
          <img
            src={
              currentContact.avatar === "" ? defaultImg : currentContact.avatar
            }
            alt=""
          />
          <div className="barInfos">
            <span className="userListName">
              {pseudoFirstLetterMaj(currentContact.pseudo)}
            </span>
        ...
        <ul id="messageContentUl">
          {messages.map((item) => {
            return item.fromSelf ? (
              <li ref={scrollRef} key={uuidv4()} className="clearfix user">
              ...
              <li ref={scrollRef} key={uuidv4()} className="clearfix invite">
